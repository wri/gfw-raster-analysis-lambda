...
LAYERS: Dict[str, Layer] = {
    ...
    "is__umd_regional_primary_forest_2001": Layer(layer="is__umd_regional_primary_forest_2001", version="v201901"),
    "umd_tree_cover_density_2000__threshold": Layer.from_encoding("umd_tree_cover_density_2000__threshold", "v1.6", encoding={
        1: 10,
        2: 15,
        3: 20,
        4: 25,
    ...
    "umd_tree_cover_gain_year": Layer(layer="umd_tree_cover_gain_year", version="v1.6"),
    "whrc_aboveground_biomass_stock_2000__Mg_ha-1": Layer(layer="whrc_aboveground_biomass_stock_2000__Mg_ha-1", version="v4", is_area_density=True),
    ...
    "tsc_tree_cover_loss_drivers__type": Layer.from_encoding("tsc_tree_cover_loss_drivers__type", "v2020", encoding=defaultdict(
        lambda: "Unknown",
        {
    ...
    "gfw_plantations__threshold": Layer.from_encoding("gfw_plantations__threshold", "v1.3", encoding={
        1: "Fruit",
        2: "Fruit Mix",
        3: "Oil Palm ",
        4: "Oil Palm Mix",
    ...
    "wdpa_protected_areas__threshold": Layer.from_encoding("wdpa_protected_areas__threshold", "v202007", encoding={
        1: "Category Ia/b or II",
        2: "Other Category"
    }),
    "esa_land_cover_2015__class": Layer.from_encoding("esa_land_cover_2015__class", "v20160111", encoding=defaultdict(
        lambda: "Unknown",
        {
            10: "Agriculture",
            11: "Agriculture",
    ...
    "birdlife_alliance_for_zero_extinction_sites": Layer(layer="birdlife_alliance_for_zero_extinction_sites", version="v20200725"),
    ...
    "ifl_intact_forest_landscapes": Layer(layer="ifl_intact_forest_landscapes", version="v20180628"),
    ...
    "birdlife_key_biodiversity_areas": Layer(layer="birdlife_key_biodiversity_areas", version="v20191211"),
    ...
    "rspo_oil_palm__certification_status": Layer(layer="rspo_oil_palm__certification_status", version="v20200114", encoding={1: "Certified", 2: "Unknown", 3: "Not certified"}),
    "idn_forest_area__type": Layer.from_encoding("idn_forest_area__type", "v201709", encoding={
    ...
    "per_forest_concession__type": Layer.from_encoding("per_forest_concession__type", "v20161001", encoding={
        1: "Conservation",
        2: "Ecotourism",
    ...
    "bra_biome__name": Layer.from_encoding("bra_biome__name", "v20150601", encoding={
        1: "Caatinga",
        2: "Cerrado",
        3: "Pantanal",
        4: "Pampa",
