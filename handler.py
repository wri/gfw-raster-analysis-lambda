...
if __name__ == '__main__':
    ...
    aoi = {"type":"FeatureCollection","features":[{"type":"Feature","properties":{},"geometry":{"type":"Polygon","coordinates":[[[-51.58355712890625,-10.40137755454354],[-51.7510986328125,-10.72807987390491],[-51.39129638671874,-10.78339562208859],[-51.398162841796875,-10.471607278043903],[-51.58355712890625,-10.40137755454354]]]}}]}

    # why this crazy structure? Oh lambda . . . sometimes I wonder
    event = {
             'body': json.dumps({'geojson': aoi}),
             'queryStringParameters': {'analysis':'loss', 'thresh': '30', 'period':'2016-01-01,2017-01-01'}
            }
    loss_raster = 'tests/data/10S_060W_loss.tif'
