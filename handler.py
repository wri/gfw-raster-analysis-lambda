...
if __name__ == '__main__':
    ...
    event_umd = {
        ...
        'queryStringParameters': {'thresh': 30, 'aggregate_values': False}
    }
    event_landcover = {
             'body': json.dumps({'geojson': aoi}),
    ...
    print('tree extent')
    umd_loss_gain(event_umd, None)
    print('landcover')
    landcover(event_landcover, None)
    print('tree cover loss on landcover')
    loss_by_landcover(event_landcover, None)
    print('tree extent on landcover')
    extent_by_landcover(event_landcover, None)
