resource "aws_lambda_function" "raster_analysis" {
  ...
  layers           = [
    ...
    local.lambda_layers.py311_numpy_226_arn,
    local.lambda_layers.py311_rasterio_143_arn,
    local.lambda_layers.py311_shapely_212_arn,
    local.lambda_layers.py311_pandas_233_arn,
  ]
...
resource "aws_lambda_function" "preprocessing" {
  ...
  layers           = [
    module.lambda_layers.raster_analysis_arn,
    local.lambda_layers.py311_numpy_226_arn,
    local.lambda_layers.py311_geopandas_112_arn,
    local.lambda_layers.py311_pandas_233_arn,
    local.lambda_layers.py311_shapely_212_arn
  ]
