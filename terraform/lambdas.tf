resource "aws_lambda_function" "raster_analysis" {
  ...
  layers           = [
    ...
    local.lambda_layers.py312_rasterio_151_arn,
    local.lambda_layers.py312_shapely_212_arn,
    local.lambda_layers.py312_pandas_232_arn,
  ]
...
resource "aws_lambda_function" "preprocessing" {
  ...
  layers           = [
    module.lambda_layers.raster_analysis_arn,
    local.lambda_layers.py312_numpy_226_arn,
    local.lambda_layers.py312_geopandas_112_arn,
    local.lambda_layers.py312_pandas_232_arn,
    local.lambda_layers.py312_shapely_212_arn
  ]
