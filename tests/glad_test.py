...
class TestAlerts(TestCase):
    ...
    def test_year_results(self):
        ...
        alert_count = self.filter_rows(year_list, 2015)
    ...
    def test_month_results(self):
        ...
        alert_count = self.filter_rows(month_list, 2017, 9)
    ...
    def test_quarter_results(self):
        ...
        alert_count = self.filter_rows(quarter_list, 2015, 2)
    ...
    def test_week_results(self):
        ...
        alert_count = self.filter_rows(week_list, 2016, 17)
    ...
    def test_day_results(self):
        ...
        alert_count = self.filter_rows(day_list, 2016, '2016-03-10')

        # how/why is this value so large? in the data but still . . . crazy
        self.assertEqual(alert_count, 24913)

    def filter_rows(self, row_list, year_val, time_val=None):
