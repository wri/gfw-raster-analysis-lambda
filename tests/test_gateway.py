...
def test_handler(mock_run_analysis, requests_mock):
    ...
    assert json.loads(result["body"]) == [
        {"loss__year": 2001, "wdpa": 0, "area": 4},
        {"loss__year": 2001, "wdpa": 1, "area": 6},
        {"loss__year": 2002, "wdpa": 0, "area": 1},
        {"loss__year": 2002, "wdpa": 1, "area": 5},
        {"loss__year": 2003, "wdpa": 0, "area": 2},
        {"loss__year": 2003, "wdpa": 1, "area": 5},
    ]

    mock_run_analysis.return_value = {
        "glad_alerts": [31001, 31001, 31002, 31002, 31003, 31003],
        "wdpa": [0, 1, 0, 1, 0, 1],
        "count": [4, 6, 1, 5, 2, 5],
    }
    ...
    result = handler(
        {
            "queryStringParameters": {
                ...
                "extent_year": "2000",
                "threshold": "30",
                "aggregate_raster_ids": "emissions",
    ...
    assert result["statusCode"] == 200
    assert json.loads(result["body"]) == [
        {"alert__date": "2017-09-28", "wdpa": 0, "count": 4},
        {"alert__date": "2017-09-28", "wdpa": 1, "count": 6},
        {"alert__date": "2017-09-29", "wdpa": 0, "count": 1},
        {"alert__date": "2017-09-29", "wdpa": 1, "count": 5},
        {"alert__date": "2017-09-30", "wdpa": 0, "count": 2},
        {"alert__date": "2017-09-30", "wdpa": 1, "count": 5},
    ]
